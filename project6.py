...
class student(object):
    ...
    def add_rec(s):
        ...
        s.mechanical=float(input("Enter marks of mechanical : "))
        s.maths=float(input("Enter marks of maths : "))
        s.python=float(input("Enter marks of python : "))
        s.english=float(input("Enter marks of english : "))
        s.total=s.physics+s.mechanical+s.maths+s.python+s.english
        s.per=s.total/5
        if(s.per>=90):
            s.grade="A1"
    ...
    def disp_rec(s):
        ...
        print("grade",s.grade)
    def display_rec(s):
        print("%-8s"%s.roll,"%-10s"%s.name,"%-10s"%s.physics,"%-12s"%s.mechanical,"%-10s"%s.maths,"%-8s"%s.python,"%-10s"%s.english,"%-10s"%s.total,"%-10s"%s.per,"%-5s"%s.grade)
    ...
    def modify_rec(s):
        ...
        s.mechanical=float(input("Enter new marks of mechanical : "))
        s.maths=float(input("Enter new marks of maths : "))
        s.python=float(input("Enter new marks of python : "))
...
def display_all():
    ...
    print("                         * SOME MILESTONES ARE WORTH SHARING *                \n")
    print("                  LIST OF MARKS OF STUDENTS OF BTECH-CS 2021-2022            \n")
    print("                                    Semester-II marksheet                    \n")
    print(110*"=")
    try:
        file=open("stud.dat","rb")
        print("%-8s"%"Rollno","%-10s"%"Name","%-10s"%"Physics","%-14s"%"mechanical","%-8s"%"Maths","%-10s"%"python","%-10s"%"English","%-10s"%"Total","%-8s"%"Per","%-5s"%"Grade")
        print(110*"=")
        while True:
...
while True:
    ...
    print("""                    Main Menu
          ------------------------
          1. Add record
          2. Display all records of students
          3. Search by rollno
          4. Search by name
          5. Modify by rollno
          6. Delete by rollno
